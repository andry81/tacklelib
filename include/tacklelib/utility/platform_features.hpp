...
#define UTILITY_COMPILER_CXX_CLANG_CONSTEXPR_RETURN CONSTEXPR_RETURN
#define UTILITY_COMPILER_CXX_NOT_CLANG_CONSTEXPR_RETURN
#else
#define UTILITY_COMPILER_CXX_CLANG_CONSTEXPR_RETURN
#define UTILITY_COMPILER_CXX_NOT_CLANG_CONSTEXPR_RETURN CONSTEXPR_RETURN
#endif
