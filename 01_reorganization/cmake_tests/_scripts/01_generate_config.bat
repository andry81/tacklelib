...
:MAIN
set "CMDLINE_SYSTEM_FILE_IN=%PROJECT_CMAKE_TESTS_CONFIG_ROOT%/_scripts/01/%~n0.system%~x0.in"
...
set "CONFIG_FILE_IN=%PROJECT_CMAKE_TESTS_CONFIG_ROOT%/_scripts/01/%~n0.deps%~x0.in"
