...
tkl_pushunset_var_to_stack(global a)
tkl_pushunset_var_to_stack(global b)

tkl_test_assert_true("NOT DEFINED a" "1 a=${a} x=${x}")
...
tkl_test_assert_true("NOT DEFINED a" "1 b=${b} x=${x}")
...
tkl_test_assert_true("NOT DEFINED b" "4 b=${b} x=${x}")
if (NOT DEFINED b) # double check
  tkl_test_assert_true(1)
else()
