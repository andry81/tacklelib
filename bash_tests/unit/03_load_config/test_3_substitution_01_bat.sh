...
function test_3_substitution_01_bat()
{
  LOAD_CONFIG_BARE_FLAGS=--expand-bat-vars
  ...
  test_load_config test_3_substitution_01_bat.vars TEST_3_VALUE_ REFERENCE_3_VALUE_ \
...
if [[ -z "$BASH_LINENO" || BASH_LINENO[0] -eq 0 ]]; then
  ...
  tkl_testmodule_run_test test_3_substitution_01_bat
fi
