...
set "CONFIG_VARS_SYSTEM_FILE_IN=%PROJECT_ROOT%/_config/config.system.vars.in"
set "CONFIG_VARS_SYSTEM_FILE=%PROJECT_ROOT%/_config/config.system.vars"
set "CONFIG_VARS_USER_FILE_IN=%PROJECT_ROOT%/_config/config.0.vars.in"
set "CONFIG_VARS_USER_FILE=%PROJECT_ROOT%/_config/config.0.vars"
