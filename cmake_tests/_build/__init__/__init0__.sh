...
CONFIG_VARS_SYSTEM_FILE_IN="$PROJECT_ROOT/cmake_tests/_config/config.system.vars.in"
CONFIG_VARS_SYSTEM_FILE="$PROJECT_ROOT/cmake_tests/_config/config.system.vars"
