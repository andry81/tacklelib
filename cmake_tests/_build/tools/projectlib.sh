...
[[ -z "$BASH" || (-n "$BASH_LINENO" && BASH_LINENO[0] -le 0) || (-n "$SOURCE_TACKLELIB_CMAKE_TESTS_BUILD_TOOLS_PROJECTLIB_SH" && SOURCE_TACKLELIB_CMAKE_TESTS_BUILD_TOOLS_PROJECTLIB_SH -ne 0) ]] && return
