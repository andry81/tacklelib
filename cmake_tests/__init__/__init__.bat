...
if defined TACKLELIB_CMAKE_TESTS_ROOT_INIT0_DIR if exist "%TACKLELIB_CMAKE_TESTS_ROOT_INIT0_DIR%\*" exit /b 0

call "%%~dp0..\..\__init__\__init__.bat" || exit /b

set "TACKLELIB_CMAKE_TESTS_ROOT_INIT0_DIR=%~d0"
...
if not defined TESTS_PROJECT_OUTPUT_CONFIG_ROOT           call "%%TACKLELIB_PROJECT_ROOT%%/__init__/canonical_path.bat" TESTS_PROJECT_OUTPUT_CONFIG_ROOT         "%%TACKLELIB_PROJECT_OUTPUT_CONFIG_ROOT%%/cmake_tests"
