...
#       define UTILITY_PLATFORM_FEATURE_CXX_STANDARD_CONSTEXPR_MULTI_RETURN
#   endif
...
#   if UTILITY_COMPILER_CXX_VERSION >= 2000
...
#ifdef UTILITY_PLATFORM_FEATURE_CXX_STANDARD_CONSTEXPR_MULTI_RETURN
#define CONSTEXPR_MULTI_RETURN constexpr
#else
#define CONSTEXPR_MULTI_RETURN
#endif
