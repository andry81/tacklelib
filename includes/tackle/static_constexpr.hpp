...
#define TACKLE_STATIC_CONSTEXPR_VALUE(type_name, ...) \
    static_constexpr_value<type_name, UTILITY_IS_CONSTEXPR_VALUE(type_name{ __VA_ARGS__ })>::construct_get(__VA_ARGS__)
...
namespace tackle
{
    ...
    public:
        ...
        FORCE_INLINE static CONSTEXPR T && construct_get(Args... args)
        {
            return T{ args... };
        }
    };
