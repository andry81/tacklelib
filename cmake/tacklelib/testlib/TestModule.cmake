...
function(tkl_testmodule_init)
  ...
  if (NOT DEFINED TACKLELIB_TESTLIB_TESTMODULE_FILE)
    message(FATAL_ERROR "TACKLELIB_TESTLIB_TESTMODULE_FILE must be defined")
  endif()
...
if (NOT TACKLELIB_TESTLIB_TESTCASE_RETCODE)
  tkl_testmodule_print_msg(\"[   OK   ] `\${TACKLELIB_TESTLIB_TESTMODULE_FILE}`: \${TACKLELIB_TESTLIB_TESTCASE_FUNC}\")
else()
  tkl_testmodule_print_msg(\"[ FAILED ] `\${TACKLELIB_TESTLIB_TESTMODULE_FILE}`: \${TACKLELIB_TESTLIB_TESTCASE_FUNC}\")
endif()
...
")
  ...
  if (NOT TACKLELIB_TESTLIB_TESTCASE_RETCODE)
    ...
    tkl_testmodule_print_msg("[ ASSERT ] `\${TACKLELIB_TESTLIB_TESTMODULE_FILE}`: ${TACKLELIB_TESTLIB_TESTCASE_FUNC}: if_exp=`${if_exp}` msg=`${msg}`")
