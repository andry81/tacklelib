...
for /F "usebackq eol=	 tokens=* delims=" %%i in (`@"%CONTOOLS_UTILITIES_BIN_ROOT%/contools/wxFileDialog.exe" "" "%TACKLELIB_PROJECT_ROOT%" "Select the third party catalog to link with..." -de`) do set "TACKLELIB_3DPARTY_ROOT=%%i"
...
rem call :CREATE_DIR_LINK "%%TACKLELIB_PROJECT_ROOT%%\_build" "%%TACKLELIB_PROJECT_ROOT%%\_3dparty\utility\tacklelib\tacklelib\_build"
