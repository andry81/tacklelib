...
[[ -z "$BASH_LINENO" || BASH_LINENO[0] -eq 0 ]] || (( ! SOURCE_TACKLELIB_TOOLS_CHECK_CONFIG_EXPIRATION_SH )) || return 0 || exit 0 # exit to avoid continue if the return can not be called
