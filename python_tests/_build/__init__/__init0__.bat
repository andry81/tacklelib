...
set "CONFIG_VARS_SYSTEM_FILE_IN=%PROJECT_ROOT%/python_tests/_config/config.system.vars.in"
set "CONFIG_VARS_SYSTEM_FILE=%PROJECT_ROOT%/python_tests/_config/config.0.vars"
