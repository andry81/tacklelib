...
set "CMDLINE_SYSTEM_FILE_IN=%PROJECT_ROOT%\config\_scripts\02\%~n0.system%~x0.in"
set "CMDLINE_USER_FILE_IN=%PROJECT_ROOT%\config\_scripts\02\%~n0.user%~x0.in"
...
set "CONFIG_FILE_IN=%PROJECT_ROOT%\config\_scripts\02\%~n0.deps%~x0.in"
