...
call :CMD "%%PROJECT_ROOT%%/_scripts/tools/set_vars_from_files.bat" ^
  ...
  --make_vars ^
  "CMAKE_CURRENT_PACKAGE_NEST_LVL;CMAKE_CURRENT_PACKAGE_NEST_LVL_PREFIX;CMAKE_CURRENT_PACKAGE_NAME;CMAKE_CURRENT_PACKAGE_SOURCE_DIR;CMAKE_TOP_PACKAGE_NAME_NAME;CMAKE_TOP_PACKAGE_NAME_SOURCE_DIR" ^
...
set "CMDLINE_FILE_IN=%PROJECT_ROOT%\_config\_scripts\04\%~nx0.in"
